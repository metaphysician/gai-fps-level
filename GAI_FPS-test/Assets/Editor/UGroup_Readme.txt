...
- With the group wizard you can specify:
  ...
  In that case you can also choose to set the position to the bottom (Y) of all
  group colliders.
  3) The group tag 
...
Version History:
 ...
 Version 1.4: - Fix for the new Unity 4.3 (and up) UNDO system
 			  - Added compatibility with lower versions
 
 Version 1.3: - Added option to place group object to bottom of all colliders (in Y)
